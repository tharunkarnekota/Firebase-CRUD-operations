                ...
                <div>
                    ...
                    Object.keys(getdata).map(key =>
                        <div className="border" style={{"width":"38rem",textAlign:"left",margin:"5px"}}>
                            ...
                            <button className="btn btn-success" onClick={()=> history.push(`/edit?firstname=${getdata[key].data.firstname}&lastname=${getdata[key].data.lastname}&email=${getdata[key].data.email}&key=${key}`)}>Update</button>&nbsp;&nbsp;
